...
{
    /// <summary>
    /// Query for fetching banned users in a channel with pagination.
    /// </summary>
    public class GimBannedUserListQuery : BaseUserListQuery<GimRestrictedUser>
    {
        /// <summary>
        ...
        internal GimBannedUserListQuery(GimBannedUserListQueryParams parameters)
        ...
        protected override async Task<(List<GimRestrictedUser> Users, string NextToken)> FetchNextAsync()
        {
            ...
            var result = await repo.GetBannedUserListAsync(
